...
public class ReceiptListResponse {
    ...
    public ReceiptListResponse(String consentReceiptId, String language, String piiPrincipalId, int tenantId, String state, String spDisplayName, String spDescription) {
