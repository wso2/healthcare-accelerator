...
@Component(
        name = "org.wso2.healthcare.apim.consentmgt.mediation",
        immediate = true)
public class ConsentMgtComponent {

    private static final Log log = LogFactory.getLog(ConsentMgtComponent.class);
