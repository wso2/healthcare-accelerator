...
INSERT INTO OH_IDN_SMART_BE_AUTH (JWT_ID, ISSUER, EXP_TIME)VALUES ('2000', 'client1', CURRENT_TIMESTAMP);
INSERT INTO OH_IDN_SMART_BE_AUTH (JWT_ID, ISSUER, EXP_TIME)VALUES ('2001', 'client1', CURRENT_TIMESTAMP);
INSERT INTO OH_IDN_SMART_BE_AUTH (JWT_ID, ISSUER, EXP_TIME)VALUES ('2002', 'client1', CURRENT_TIMESTAMP);
...
INSERT INTO IDN_OAUTH_CONSUMER_APPS (ID, CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, USER_DOMAIN, APP_NAME,
            OAUTH_VERSION, CALLBACK_URL, GRANT_TYPES, APP_STATE) VALUES
            (3, 'O99Y3oCCCluRc0dQASZkkFMvOZEa', 'testSecret2', 'testUser2', 1234, 'PRIMARY',
            'myApp2', 'OAuth-2.0', 'http://localhost:8080/redirect',
            'refresh_token password iwa:ntlm client_credentials', 'ACTIVE');
