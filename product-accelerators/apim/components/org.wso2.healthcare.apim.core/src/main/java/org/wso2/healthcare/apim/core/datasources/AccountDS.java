...
/**
 * Holds SaaS Account database of Open-Healthcare platform
 */
public class AccountDS extends AbstractDataSource {

    private static final String DEFAULT_OH_DS_NAME = "jdbc/OHAccountDB";
    private static final Log LOG = LogFactory.getLog(AccountDS.class);

    private static final AccountDS instance = new AccountDS();
