...
<% 
    String privacyPolicy = DeploymentConfigAPI.getWebappPrivacyPolicy();
    String cookiePolicy = DeploymentConfigAPI.getWebappCookiePolicy();
%>
...
<%
    ...
    org.json.JSONObject usernameValidityResponse;
...
<body>
    <main class="center-segment" style="width:600px; margin-top: 50px;">
                    ...
                    <form class="ui large form" action="../commonauth" method="post" id="register">
                        ...
                        <form class="ui large form" action="processregistration.do" method="post" id="register">
                            ...
                            <div class="">
                                ...
                                <div class="ui visible negative message" id="error-msg" hidden="hidden">
                                </div>

                                <% if (isPasswordProvisionEnabled || !skipSignUpEnableCheck) { %>
                                <p class="filltheformText">
                            ...
                            <div>
                                ...
                                <div class="two fields">
                                    <div class="twoFieldContainer">
                                        ...
                                        %>
                                        <div class="material-textfield" style="margin-right: 15px;">
                                            <div class="<% if (firstNamePII.getRequired() || !piisConfigured) {%> required <%}%> field">
                                                <input type="text" name="http://wso2.org/claims/givenname" class="form-control" style="width:220px;" placeholder=" "
                                        ...
                                        <div class="material-textfield">
                                            <div class="<% if (lastNamePII.getRequired() || !piisConfigured) {%> required <%}%> field">
                                                <input type="text" name="http://wso2.org/claims/lastname" class="form-control" style="width:220px;"placeholder=" "
                                    ...
                                    <div class="twoFieldContainer">
                                        <div class="required field">
                                            <div class="material-textfield" style="margin-right: 15px;">
                                                ...
                                                style="width:220px;" placeholder=" " required>
                                                <label class="control-label">
                                        ...
                                        <div class="required field">
                                            <div class="material-textfield">
                                                <input id="password2" name="password2" type="password" class="form-control" style="width:220px;" placeholder=" "
                                ...
                                <div class="fieldContainer">
                                    <div class="material-textfield">   
                                        <div class="<% if (emailNamePII.getRequired() || !piisConfigured) {%> required <%}%> field">
                                            <input type="email" name="http://wso2.org/claims/emailaddress" class="form-control" style="width:480px;" placeholder=" "
                                                data-validate="email"
                                                <% if (emailNamePII.getRequired() || !piisConfigured) {%> required <%}%>
                                                <% if (skipSignUpEnableCheck && StringUtils.isNotEmpty(emailValue)) {%>
                                    ...
                                    <div class="fieldContainer">
                                        <div class="material-textfield">  
                                            <input type="text" name="missing-<%=Encode.forHtmlAttribute(claim)%>"
                                                id="<%=Encode.forHtmlAttribute(claim)%>" class="form-control" style="width:480px;" placeholder=" "
                                                required="required">
                                                <label class="control-label">
                                    ...
                                    <div class="material-textfield">  
                                        <div class="<% if (claim.getRequired()) {%> required <%}%>field">
                                            <input type="text" name="<%= Encode.forHtmlAttribute(claimURI) %>"
                                                class="form-control" style="width:480px;" placeholder=" "
                            ...
                            <div>
                                <div class="fieldContainer">
                                    <div class="material-textfield">  
                                        <div class="field">
                                            <input type="text" class="form-control" style="width:480px;" placeholder=" "
                            ...
                            <div class="field">
                                ...
                                <div>
                                    ...
                                    <div class="infoBoxContent">
                                        <div>
                                            ...
                                            <!-- <a href="/authenticationendpoint/cookie_policy.do" target="policy-pane"></a> -->
                                            <a href="<%=cookiePolicy%>" target="policy-pane">
                                                <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                                                        "Cookie.policy")%>
                                            </a>
                                ...
                                <div>
                                    ...
                                    <div class="required field">
                                        <div class="ui checkbox" style="display: flex;  align-items: center; margin-bottom: 0px;">
                                            <input id="termsCheckbox" type="checkbox" class="privacyCheckbox"/>
                                            <p class="privacyCheckboxLabel"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                                                    "I.confirm.that.read.and.understood")%>
                                                <!-- <a href="/authenticationendpoint/privacy_policy.do" target="policy-pane"> -->
                                                <a href="<%=privacyPolicy%>" target="policy-pane"> 
                                ...
                                <% if (!skipSignUpEnableCheck) { %>
                                <div class="infoBoxContent">
                                    <p><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "Already.have.account")%>
                                        <a href="<%=Encode.forHtmlAttribute(loginUrl)%>" id="signInLink">
