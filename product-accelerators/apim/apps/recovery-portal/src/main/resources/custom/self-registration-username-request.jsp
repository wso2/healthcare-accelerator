            ...
            <div class="ui segment">
			   ...
			   <div class="material-textfield">
			    ...
			    <label class="control-label"
                                   for="username"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "Enter.your.username.here")%>
                            </label>	 
			  </div>	
                        </div>
                        ...
                        <div style="display: flex; margin-top: 2em; margin-bottom: 1em;">
                            <button id="goBack" onclick="window.location.href='/devportal'" class="cancelButton" type="button">
