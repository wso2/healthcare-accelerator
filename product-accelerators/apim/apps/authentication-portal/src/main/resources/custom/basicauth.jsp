...
<% 
    String termsOfUse = DeploymentConfigAPI.getWebappTermsOfUse();
    ...
    Boolean isSelfSignupEnabled = DeploymentConfigAPI.isWebappSelSignupEnable();
    String selfSignupURL = DeploymentConfigAPI.getWebappSelfSignupURL();
    String disclaimerPortalName = DeploymentConfigAPI.getSigninDisclaimerPortalName();
%>
...
<form class="ui large form" action="<%=loginFormActionURL%>" method="post" id="loginForm">
    ...
    %>
        <div class="ui visible warning message">
            <p>
            Usage of <%=disclaimerPortalName%> is subject to the
    ...
    <div class="mt-0">
        ...
        <div class="ui large button link-button">
            <p style="color: #656565; font-size: 15px; ">Don't have an account?
            <%
            ...
            <a
                            id="registerLink"
                            tabindex="8"
                            href="<%=StringEscapeUtils.escapeHtml4(getRegistrationUrl(accountRegistrationEndpointURL, urlEncodedURL, urlParameters))%>"
