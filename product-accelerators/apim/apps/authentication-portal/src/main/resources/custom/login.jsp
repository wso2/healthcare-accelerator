...
<% 
    String themeColor = DeploymentConfigAPI.getWebappMainColor();
%>
            ...
            <div class="ui segment">
                <h3 class="ui header ellipsis">
                    <% if (isIdentifierFirstLogin(inputType)) { %>
                        ...
                        <div id="user-name-label" class="display-inline" data-position="top left" data-variation="inverted" data-content="<%=Encode.forHtmlAttribute(usernameIdentifier)%>"><%=Encode.forHtmlAttribute(usernameIdentifier)%></div>
                    <% } else { %>
