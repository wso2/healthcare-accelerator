            ...
            <div class="ui segment">
                <form class="ui large form" action="<%=oauth2AuthorizeURL%>" method="post" id="profile" name="oauth2_authz">
                    ...
                    <div class="segment-form">
                        ...
                        <div class="align-right buttons" style="display: flex; margin-top: 2em; margin-bottom: 1em;">
                             <input type="hidden" name="<%=Constants.SESSION_DATA_KEY_CONSENT%>"
                                                                 value="<%=Encode.forHtmlAttribute(request.getParameter(Constants.SESSION_DATA_KEY_CONSENT))%>"/>
                             <input type="hidden" name="consent" id="consent" value="deny"/>

                             <button class="large button" type="reset" onclick="deny(); return false;">Deny</button>
                             <button type="button" class="ui primary large button" id="approve" name="approve"
                                    onclick="approved(); return false;">Allow</button>
                        </div>
